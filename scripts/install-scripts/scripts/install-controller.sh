...
function start_addons {
	...
	curl --silent -XPOST -H "Content-Type: application/yaml" -d"$(cat /srv/kubernetes/manifests/calico-replicaset.yaml)" "http://127.0.0.1:8080/apis/extensions/v1beta1/namespaces/kube-system/replicasets" > /dev/null
	echo "K8S: DNS addon"
